...
function checkVariable(decl, context) {
    ...
    for (const declaration of decl.declarations) {
        for (const id of (0, index_js_1.resolveIdentifiers)(declaration.id)) {
...
function checkFunction(func, context) {
    ...
    for (const param of func.params) {
        for (const id of (0, index_js_1.resolveIdentifiers)(param)) {
...
function checkCatch(catchh, context) {
    if (catchh.param) {
        for (const id of (0, index_js_1.resolveIdentifiers)(catchh.param)) {
            raiseOnInvalidIdentifier(id, 'parameter', context);
        }
    }
}
