...
exports.rule = {
    ...
    create(context) {
        ...
        function checkBinaryExpression(expression) {
            ...
            if ((0, index_js_1.isBooleanLiteral)(left)) {
                reportWithFix(left, fixer => getBinaryFix(fixer, expression, left, right, operator));
            }
            if ((0, index_js_1.isBooleanLiteral)(right)) {
        ...
        function checkLogicalExpression(expression) {
            ...
            if (operator === '&&' && (0, index_js_1.isBooleanLiteral)(right)) {
            ...
            if (operator === '||' &&
                (0, index_js_1.isBooleanLiteral)(right) &&
        ...
        function checkUnaryExpression(unaryExpression) {
            ...
            if ((0, index_js_1.isBooleanLiteral)(argument)) {
